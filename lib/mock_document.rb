...
module Colore
  ...
  class MockDocument
    ...
    def generate_mock_file_content(filename)
      ...
      case extension
      when 'txt' then generate_txt_content
      when 'pdf' then generate_pdf_content
      when 'docx' then generate_docx_content
      when 'html' then generate_html_content
      when 'json' then generate_json_content
      else generate_default_content(filename)
      end
    end
    ...
    def generate_default_content(filename)
